      ...
      setMessages([
        {
          ...
          content: `Hi ${customer?.name}! As a valued customer, we're excited to offer you 25% off on your next purchase. Your excellent taste deserves the best deals!`,
          sender: 'Convexa AI',
          timestamp: '2024-04-11T10:30:00Z',
          read: false,
          platform: 'whatsapp',
          campaign_name: 'VIP Customer Campaign'
        },
        {
          id: 2,
          type: 'offer',
          subject: 'Your Cart is Waiting! Complete Your Purchase 🛒',
          content: 'Don\'t miss out on your iPhone 15 Pro and AirPods! Complete your purchase now and get free express delivery.',
          sender: 'Convexa AI',
        ...
        },
        {
          id: 3,
          type: 'notification',
          subject: 'Welcome to Convexa! 🎉',
          content: 'Thank you for joining Convexa! We\'re excited to provide you with personalized shopping experiences and exclusive deals.',
          sender: 'Convexa Team',
        ...
        },
        {
          ...
          content: 'Limited time offer! Get 30% off on all electronics including the MacBook Pro you viewed recently. Sale ends in 24 hours!',
          sender: 'Convexa AI',
        ...
        },
        {
          ...
          content: 'You\'ve earned 1000 loyalty points! Redeem them now for ₹500 instant discount on your next purchase.',
          sender: 'Convexa AI',
